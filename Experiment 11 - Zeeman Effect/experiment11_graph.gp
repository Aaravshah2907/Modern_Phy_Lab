...
set style line 1 linecolor rgb "#E41A1C" lw 2 pt 7 ps 0.05 # Red (Circle)
...
set ylabel "Magnetic Field (Gauss)"
...
Calculate(x) = 0.2187*x + 0.0014 # User define function

#set label "B = 400 Gauss" at 3,20

plot 'numbers.csv' using 1:(Calculate($1)) title 'Magnetic Field' w lp ls 1,\
