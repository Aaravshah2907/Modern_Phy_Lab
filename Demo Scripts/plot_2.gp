...
set multiplot layout 1,2 # Two rows and 1 column 
set size square
...
set xlabel 'X-label Second Plot'
set ylabel 'Y-label Second Plot'

set autoscale 

plot 'file_two_set.dat' using 1:2 index 0:0 title 'f(x)' w lp ls 1,\
'file_two_set.dat' using 1:2 index 1:1 title 'g(x)' w lp ls 2,\
