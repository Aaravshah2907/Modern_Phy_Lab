...
set style line 1 linecolor rgb "#E41A1C" lw 2 pt 7 ps 0.5 # Red (Circle)
set style line 2 linecolor rgb "#377EB8" lw 2 pt 7 ps 0.5 # Blue (Square)
set style line 3 linecolor rgb "#4DAF4A" lw 2 pt 7 ps 0.5 # Green (Triangle)
set style line 4 linecolor rgb "#FF7F00" lw 2 pt 7 ps 0.5 # Orange (Star)
...
plot 'experimental_readings.csv' using 10:3 title 'nu = 12 MHz' w lp ls 1,\
'experimental_readings.csv' using 10:5 title 'nu = 13 MHz' w lp ls 2,\
'experimental_readings.csv' using 10:7 title 'nu = 14 MHz' w lp ls 3,\
'experimental_readings.csv' using 10:9 title 'nu = 15 MHz' w lp ls 4,\
