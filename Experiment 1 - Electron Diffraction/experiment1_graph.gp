...
set xlabel "Wavelength in picometres"
set ylabel "Radius in millimetres"
...
plot 'experimental_readings.csv' using 6:4 title 'R1(mm)' w lp ls 1,\
'experimental_readings.csv' using 6:5 title 'R2(mm)' w lp ls 2,
