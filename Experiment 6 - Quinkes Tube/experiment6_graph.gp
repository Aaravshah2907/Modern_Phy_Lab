...
set output 'Experimental_graph_3.svg'
...
set xlabel "Magnetic Field ^2 (B^2) (G^2)"
set ylabel "Height (h) (cm)"

# Either set autoscale or custom range (default- autoscale)
set autoscale 
#set xrange[20000:210000] rotate by 90
#set yrange[150:180]
...
plot 'experimental_data.csv' using 6:8 title 'B^2 vs h' w lp ls 1,\