...
set xlabel "Magnetic Field (Tesla)"
...
plot 'experimental_readings.csv' using 4:5 title 'Red Laser' w lp ls 1,\
'experimental_readings.csv' using 4:6 title 'Green Laser' w lp ls 3,\
